...
<body>
    <div class="gabut" style="background-image: url(/images/bghomepage.jpg);background-size: 100% 100%;background-repeat: no-repeat;">
            ...
            <div id="myCarousel" class="carousel slide py-5" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div id="headcarousel" class="carousel-item">
                        ...
                        <img class="responsive" src="/images/logo.jpg" alt="">
                        <div class="container">
        ...
        <div class="container marketing pt-5" style="margin-bottom: -30px;">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="/images/logo.jpg" alt="">
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-ride="carousel" data-interval="3000">
                        <div id="imgarticle" class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto responsive" width="500" height="500" src="/images/image1.jpg" alt="">
                            </div>
